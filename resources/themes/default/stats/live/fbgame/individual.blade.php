<div class="tabs-nav">
    <ul>
        <li class="active" >
            <a href="#individual" class="tab-link">Individual</a>
        </li>
        <li>
            <a href="#team" class="tab-link">Team Statistics</a>
        </li>
        <li>
            <a href="#drive_chart" class="tab-link">Drive Chart</a>
        </li>
        <li>
            <a href="#participation" class="tab-link">Participation</a>
        </li>
    </ul>
</div>
<div class="tabs-list">
    <div class="tab active" id="individual">
    ...
    <div class="tab" id="participation">
        @isset( $starters['data'] )
