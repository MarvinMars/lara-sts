    ...
    <header class="main-header">
        ...
        <a href="{{ url(config('backpack.base.route_prefix')) }}" class="logo">
            ...
            <span class="logo-mini">
                <img src="{!! asset(config('backpack.base.logo_mini')) !!}"
                     alt="{!! config('backpack.base.logo_mini_alt') !!}">
            </span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg">
                <img src="{!! asset(config('backpack.base.logo_lg')) !!}"
                     alt="{!! config('backpack.base.logo_lg_alt') !!}">
            </span>
        </a>
