...
namespace App\Classes\Stats\Sports\Career\Softball;
...
class Pitching extends AbstractCareer
{
    ...
    public function sho()
    {
        return $this->_sumByGroupKey('hitting', 'sho');
    }

    public function sv()
    {
        return $this->_sumByGroupKey('hitting', 'save');
    }
    ...
    public function b_avg()
    {
        ...
        return ($atBats > 0) ? ($hits / $atBats) : 0.000;
    }

    public function wp()
    {
        return $this->_sumByGroupKey('hitting', 'wp');
    }

    public function hbp()
    {
        return $this->_sumByGroupKey('hitting', 'hbp');
    }

    public function bk()
    {
        return $this->_sumByGroupKey('hitting', 'bk');
    }
    ...
    public function obp()
    {
        $obp = ( $this->h() + $this->bb() + $this->hbp() ) / ( $this->ab() + $this->bb() + $this->hbp() );
        return $obp;
    }
